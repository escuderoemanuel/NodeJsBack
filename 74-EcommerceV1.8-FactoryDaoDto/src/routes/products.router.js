...
router.get('/', verifyToken, getRole('user'), ProductsController.getAll)
// router.get('/', ProductsController.getAll)

// Deberá traer sólo el producto con el id proporcionado
router.get('/:pid', verifyToken, getRole('user'), ProductsController.getById)
// router.get('/:pid', ProductsController.getById)

// Deberá agregar un nuevo producto
router.post('/', verifyToken, getRole('user'), ProductsController.create);
// router.post('/', ProductsController.create);

// Deberá actualizar un producto existente con el id proporcionado.
router.put('/:pid', verifyToken, getRole('user'), ProductsController.update)
// router.put('/:pid', ProductsController.update)

// Deberá eliminar un producto existente con el id proporcionado.
router.delete('/:pid', verifyToken, getRole('user'), ProductsController.delete)
