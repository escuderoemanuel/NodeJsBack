//! En esta versión lo que sucede es que al crear el archivo en una función async, puede que tarde en crearla más que lo que tarda en lanzarse la siguiente función, lo que regresa por consola un error en la siguiente función por haber terminado antes y depender de la primera!!
...
const test = async () => {
  ...
  const manager = new ProductManager('./productManagerALERT.json');
